...
def create_app():
    ...
    CORS(account_bp, supports_credentials=True, origins=["http://localhost:64749"])
    ...
    app.register_blueprint(account_bp, supports_credentials=True, origins="http://localhost:64749") 
